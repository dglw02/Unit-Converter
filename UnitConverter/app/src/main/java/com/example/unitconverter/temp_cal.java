    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cv_toUnit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("choose Unit");//                 Hiện danh sách unit muốn đổi

                final String[] flowers = new String[]{
                        "Celcius",
                        "Fahrenheit",
                        "Kelvin",//                  danh sách unit
                        "Rankine",
                        "Newton", "Delisle"
                };
                ...
                builder.setSingleChoiceItems(
                        ...
                        });//                       Đổi tên cho textview to unit muốn đổi
                ...
                });//                   Select Unit muốn chọn và tắt danh sách unit
